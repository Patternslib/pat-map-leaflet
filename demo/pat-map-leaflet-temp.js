        ...
        init: function($el, options) {
            ...
            $.MapController = function(el, options) {
                ...
                */
                ...
                /**
                 * display layer controls on the map based on the available layers
                 */
                base._addLayerControls  = function(){
                    var baseMaps = {};
                    var overlayMaps = {};
                    var i=0;
                    for (var lay in base.layers){
                        var layer = base.layers[lay];
                        var options = base.options.layers[i];
                        ...
                        if(options.layerControl){
                            if(layer.options.baselayer){
                                ...
                                overlayMaps[lay] = layer;
                            }
                        }
                        i+=1;
                    }
                    
                    L.control.layers(baseMaps, overlayMaps).addTo(base.map);
                };
                ...
                base._addTMS = function(layerOptions){
                    ...
                    base.layers[layerOptions.title] = LLayer;
