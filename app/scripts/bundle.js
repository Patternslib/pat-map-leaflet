/**
 * Patterns bundle 1.5.0-d525fd07
 *
...
define('pagedown/Markdown.Converter',['require','exports','module'],function(require, exports, module) {
var Markdown;
...
define('pagedown', ['pagedown/Markdown.Converter'], function (main) { return main; });

define('pagedown/Markdown.Sanitizer',['require','exports','module','./Markdown.Converter'],function(require, exports, module) {
(function () {
...
define('pagedown-extra/extra',['pagedown'], function(Markdown) {
(function () {
...
define('pagedown-extra', ['pagedown-extra/extra'], function (main) { return main; });
...
// jshint indent: 4, browser: true, jquery: true, quotmark: double
// vim: sw=4 expandtab
;require(['registry', "pat/autosubmit", "pat/form-state", "pat/inject", "pat/markdown", "pat/subform"], function(r){r.init();});